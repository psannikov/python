...
class SQLWorker:
    ...
    TOP_SKILL_IN_ALL_VACANCY = 'ТОП10 скилов по всем вакансиям Python Developer.xlsx'
    TOP_SKILL_IN_VACANCY_BY_INDUSTRY_ID = 'ТОП10 скилов по вакансиям Python Developer компании по данным HH.xlsx'
    TOP_SKILL_IN_VACANCY_FILTER_COMPANIES = 'ТОП10 скилов по вакансиям Python Developer фильт компаний по ОКВЕД.xlsx'
